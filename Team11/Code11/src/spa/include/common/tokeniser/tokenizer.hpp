...
class Tokenizer {
    protected:
         ...
         * @return An optional tuple containing the token and the remaining input, or an empty optional if the token is not found.
         */
    ...
    public:
         ...
         * 
         * @param input The input string to tokenize.
         * @return An optional tuple containing the token and the remaining input, or an empty optional if the tokenization fails.
         */
