...
auto ModifiesSEvaluator::eval_modifies(const std::shared_ptr<ReadFacade>& read_facade) {
    return overloaded {
            ...
            [read_facade](const std::shared_ptr <qps::StmtSynonym> &synonym,
                ...
                const auto var_vec =
                        std::vector < std::string > {relevant_variables.begin(), relevant_variables.end()};
            ...
            [read_facade](const std::shared_ptr <qps::StmtSynonym> &synonym,
                ...
                const auto relevant_stmts = scan_entities(read_facade, synonym);
                const auto relevant_stmt_vec = std::vector < std::string > {relevant_stmts.begin(),
                                                                            relevant_stmts.end()};
            ...
            [read_facade](const qps::Integer &stmt_num,
                ...
                const auto does_modify =
                        read_facade->does_statement_modify_var(std::to_string(stmt_num.value),
