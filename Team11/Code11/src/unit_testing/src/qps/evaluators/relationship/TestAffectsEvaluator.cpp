...
//            std::vector<std::shared_ptr<Clause>>{
//                std::make_shared<SuchThatClause>(
//                    Affects{std::make_shared<AnyStmtSynonym>("s1"), Integer{"5"}}, false),
//            },
//        };
//
...
//    }
    ...
    SECTION("Evaluate - Select s1 such that Affects (s1, _)") {
        const auto query = Query{
            ...
            std::vector<std::shared_ptr<Clause>>{
                std::make_shared<SuchThatClause>(
                    Affects{std::make_shared<AnyStmtSynonym>("s1"), WildCard{}}, false),
            },
        };
...
//            std::vector<std::shared_ptr<Clause>>{
//                std::make_shared<SuchThatClause>(
//                    Affects{Integer{"1"}, std::make_shared<AnyStmtSynonym>("s1")}, false),
//            },
//        };
//
...
//    }
    ...
    SECTION("Evaluate - Select s1 such that Affects (2, 4)") {
        const auto query = Query{
            ...
            std::vector<std::shared_ptr<Clause>>{
                std::make_shared<SuchThatClause>(
                    Affects{Integer{"2"}, Integer{"4"}}, false),
            },
        };
    ...
    SECTION("Evaluate - Select s1 such that Affects (1, _)") {
        const auto query = Query{
            ...
            std::vector<std::shared_ptr<Clause>>{
                std::make_shared<SuchThatClause>(
                    Affects{Integer{"1"}, WildCard{}}, false),
            },
        };
...
//            std::vector<std::shared_ptr<Clause>>{
//                std::make_shared<SuchThatClause>(
//                    Affects{WildCard{}, std::make_shared<AnyStmtSynonym>("s1")}, false),
//            },
//        };
//
...
//    }
    ...
    SECTION("Evaluate - Select s1 such that Affects (_, 4)") {
        const auto query = Query{
            ...
            std::vector<std::shared_ptr<Clause>>{
                std::make_shared<SuchThatClause>(
                    Affects{WildCard{}, Integer{"4"}}, false),
            },
        };
    ...
    SECTION("Evaluate - Select s1 such that Affects (_, _)") {
        const auto query = Query{
            ...
            std::vector<std::shared_ptr<Clause>>{
                std::make_shared<SuchThatClause>(
                    Affects{WildCard{}, WildCard{}}, false),
            },
        };
...
//            std::vector<std::shared_ptr<Clause>>{
//                std::make_shared<SuchThatClause>(
//                    Affects{Integer{"3"}, Integer{"3"}}, false),
//            },
//        };
//
//        require_equal(evaluator.evaluate(query), assign_strs);
...
//        };
//
//        require_equal(evaluator.evaluate(query), std::vector<std::string>{"3", "5"});
//    }
//
...
//            std::vector<std::shared_ptr<Clause>>{
//                std::make_shared<SuchThatClause>(
//                    Affects{WildCard{}, Integer{"5"}}, false),
//            },
//        };
//
//        require_equal(evaluator.evaluate(query), assign_strs);
