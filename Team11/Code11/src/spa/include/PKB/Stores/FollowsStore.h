...
class FollowsStore {
  public:
     ...
     */
    void addFollows(const StatementNumber& s1, const StatementNumber& s2);
     ...
     */
    [[nodiscard]] bool hasFollows(const StatementNumber& s1, const StatementNumber& s2) const;
     ...
     */
    [[nodiscard]] StatementToStatementMap getAllFollows() const;
     ...
     */
    [[nodiscard]] StatementSet getAllFollowsKeys() const;
     ...
     */
    [[nodiscard]] StatementSet getAllFollowsValues() const;
     ...
     */
    [[nodiscard]] StatementNumber getFollowsFollowing(const StatementNumber& s) const;
     ...
     */
    [[nodiscard]] StatementNumber getFollowsBy(const StatementNumber& s) const;
     ...
     */
    void addFollowsStars(const StatementNumber& s1, const StatementNumber& s2);
     ...
     */
    [[nodiscard]] bool hasFollowsStars(const StatementNumber& s1, const StatementNumber& s2) const;
     ...
     * statements.
     */
    [[nodiscard]] StatementToSetMap getAllFollowsStar() const;
     ...
     */
    [[nodiscard]] StatementSet getAllFollowsStarKeys() const;
     ...
     */
    [[nodiscard]] StatementSet getAllFollowsStarValues() const;
     ...
     */
    [[nodiscard]] StatementSet getFollowsStarsFollowing(const StatementNumber& s) const;
