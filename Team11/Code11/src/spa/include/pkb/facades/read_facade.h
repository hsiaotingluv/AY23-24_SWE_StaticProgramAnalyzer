...
class ReadFacade {
  public:
    ...
    std::unordered_set<std::string> get_all_statements_that_modify(const StatementType& statementType);
    ...
    get_all_statements_and_var_modify_pairs(const StatementType& statementType);
    ...
    std::unordered_set<std::string> get_all_statements_that_use(const StatementType& statementType);
    ...
    std::unordered_set<std::tuple<std::string, std::string>>
    get_all_statements_and_var_use_pairs(const StatementType& statementType);
    ...
    std::string get_statement_following(const std::string& s, const StatementType& statementType) const;

    std::string get_statement_followed_by(const std::string& s) const;

    std::string get_statement_followed_by(const std::string& s, const StatementType& statementType) const;
    ...
    std::unordered_set<std::string> get_all_parent_keys(const StatementType& statementType) const;

    std::unordered_set<std::string> get_all_parent_values() const;

    std::unordered_set<std::string> get_all_parent_values(const StatementType& statementType) const;
    ...
    std::string get_parent_of(const std::string& child, const StatementType& statementType) const;
    ...
    std::unordered_set<std::string> get_all_parent_star_keys(const StatementType& statementType) const;

    std::unordered_set<std::string> get_all_parent_star_values() const;

    std::unordered_set<std::string> get_all_parent_star_values(const StatementType& statementType) const;
