...
auto PatternAssignEvaluator::eval_pattern(const std::shared_ptr<Synonym>& synonym,
    ...
    auto table = Table{{pattern.get_assign_synonym(), synonym}};
...
auto PatternAssignEvaluator::eval_pattern(const std::shared_ptr<Synonym>& synonym, const WildCard&) const -> OutputTable {
    auto table = Table{{pattern.get_assign_synonym(), synonym}};
...
auto PatternAssignEvaluator::eval_pattern(const QuotedIdent& quoted_ident, const PartialMatch& partial_match) const
    -> OutputTable {
    auto table = Table{{pattern.get_assign_synonym()}};
...
auto PatternAssignEvaluator::eval_pattern(const QuotedIdent& quoted_ident, const ExactMatch& exact) const -> OutputTable {
